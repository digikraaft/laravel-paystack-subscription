...
class SubscriptionBuilder
{
    ...
    public function create(string $transactionId = null, string $authorization = null, array $customerOptions = [])
    {
        ...
        $this->authorization = $paystackSubscription->authorization->authorization_code;
        $this->owner->save();
        ...
        $subscription = Subscription::create([
            ...
            'ends_at' => Carbon::parse($paystackSubscription->next_payment_date),
            app(config('paystacksubscription.model'))->getForeignKey() => $this->owner->id,
        ]);
